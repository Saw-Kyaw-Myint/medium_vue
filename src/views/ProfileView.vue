<template>
    <div id="overlay" v-if="updatePassword || changePassword"></div>
    <div class="container">
        <div class="profile">
            <div class="clearfix">
                        ...
                        <div class="clearfix">
                            ...
                            <div class="pf-right-side">
                                ...
                                <div id="edit-profile" class=" " v-if="updateProfile">
                                    <form action="" method="POST" class="user-edit" enctype="multipart/form-data">
                                        <span class="x"><i class="fa-solid fa-x"></i></span>

                                        <h3 class="edit-ttl">Edit Your Information</h3>
                                        <div class="profile-image">
                                            <img src="" alt="prview image" id="output"><br>
                                ...
                                <div class="edit-update">
                                    <p id="ex1" @click="updateProfile= ! updateProfile"><a href="#">Edit Profile</a> </p>
                                    <p id="ex2" @click="changePassword= ! changePassword"><a href="#"> Update Password</a>
                                       </p>
                                </div>
                        ...
                        <div class="mypost-whole" v-for="(post, index) in posts" :key="index">
                          ...
                          <router-link :to="{name:'profile',parms:{id:post?.user?.id}}">
                            <div class="pls-myPost">
                                <p> <img :src="url + post?.user?.profile" alt="">
                                    <span>{{ post?.user?.name }}
                                        <span>{{ post?.created_at }}</span> </span>
                                </p>
                            </div>
                        </router-link>
                ...
                <div class="">
                    <div class="profile-right-side">
                        <div class="category-list">
                            ...
                            <div class="latest-post-whole" v-for="(latestpost, index) in latestPosts" :key="index">
                                <div class="latest-post">
                                    ...
                                    <router-link :to="{ name: 'profile', params: { id: latestpost.user?.id } }">
                        ...
                        <div class="category-item">
                            <p v-for="(category, index) in categories" :key="index"><span
                                    @click="categorySearch(category.ctitle)">{{ category.ctitle }}</span></p>
                        </div>
...
watchEffect(async () => {
    ...
    await axios.get(`http://127.0.0.1:8000/api/profile/${route.params.id}`).then((response) => {
